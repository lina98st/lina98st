# 💫 About Me:
👋 Hi, I’m Alina @lina98st<br>Tech Skills: HTML, CSS/SCSS, JavaScript, jQuery, Node.js, Vue.js, TailwindCSS<br>React (currently learning)<br>MBTI Personality type: INTJ<br>
<br>
# 💻 Tech Stack:
